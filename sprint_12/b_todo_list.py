...
# https://github.com/Yandex-Practicum/algorithms-templates/blob/main/python/sprint2/B/code.py
"""
B. Список дел
...
соответствует вашему языку. Иначе даже корректно написанное
решение не пройдет тесты.
